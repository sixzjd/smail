...
const dbInit = {
	...
	async v3_2DB(c) {
		const indexSqls = [
			`CREATE INDEX IF NOT EXISTS idx_email_list ON email(user_id, type, is_del, email_id);`,
	...
	async v1_6DB(c) {
		...
		const ADD_COLUMN_SQL_LIST = [
			...
			`ALTER TABLE setting ADD COLUMN notice_title TEXT NOT NULL DEFAULT 'smail';`,
